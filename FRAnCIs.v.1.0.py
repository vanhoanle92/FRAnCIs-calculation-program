...
## designe a pop-up to notify "out of range"
def popupmsg_OCR():
    popup_OCR=tk.Tk()
...
class FRAnCIs: 
	def __init__(self, master):
		self.master = master
		self.master.title("FRAnCIs v.1.0, GeoRessouces Lab")
...
class module1: 
	def __init__(self, master, number):
		...
		self.master.title("FRAnCIs v.1.0 - (pure CO₂)")
		self.master.resizable(width=False, height=False)
		self.master.iconbitmap(resource_path("logo.ico"))
		self.frame=tk.Frame(self.master)
		self.frame.grid()
		...
		self.label= tk.Label(self.frame, text="  at near-zero density are needed for pressure and density determinations")
		...
		self.label = tk.Label(self.frame, text="   - \u0394_sample must be measured at the beginning and at the end of the experiment section.")
		...
		self.Rbtn1=tk.Radiobutton(self.frame, text="Others", variable=instrument, value=2, padx = 20,  command=selected_instrument).grid(row=12, column=3,  padx=10, sticky="W")
		...
		def calculCO2pure():
			...
			if temperature.get() == 22 and instrument.get() ==1:
				...
				uncer_pressure_final = 5.7 + (max(pressure1, pressure2) - min(pressure1, pressure2))/(2*np.sqrt(3))  #uncertainty=8
				...
				uncer_density_final = 0.003 + (max(density1,density2)-min(density1,density2))/(2*np.sqrt(3)) #uncertainty = 0.003
...
class module2: 
	def __init__(self, master, number):
		self.master = master
		self.master.title("FRAnCIs v.1.0 - (pure CH₄)")
		...
		self.label = tk.Label(self.frame, text="The CH₄ \u03BD₁ band position of the sample (\u03BD₁_sample) and of the standard at near-zero density (\u03BD₁_std)")
...
class module3: 
	def __init__(self, master, number):
		self.master = master
		self.master.title("FRAnCIs v.1.0 - (CO₂-N₂ mixtures)")
		...
		self.Rbtn1=tk.Radiobutton(self.frame, text="Others", variable=instrument, value=2, padx = 20, pady = 5, command=selected_instrument).grid(row=26, column=2, stick="W",  padx=10)
		...
		self.label = tk.Label(self.frame, text="are_N2_sample")
		self.label.grid(row=27, column=1, padx=10)
		self.label = tk.Label(self.frame, text="are_N2_atm")
...
class module4: 
	def __init__(self, master, number):
		self.master = master
		self.master.title("FRAnCIs v.1.0 - (CH₄-N₂ mixtures)")
...
class module5: 
	def __init__(self, master, number):
		self.master = master
		self.master.title("FRAnCIs v.1.0 - (CO₂-CH₄ mixtures)")
		...
		self.Rbtn1=tk.Radiobutton(self.frame, text="Others", variable=instrument, value=2, padx = 20, pady = 5, command=selected_instrument).grid(row=21, column=2,  padx=10, sticky="W")
...
class module6: 
	def __init__(self, master, number):
		self.master = master
		self.master.title("FRAnCIs v.1.0 - (CO₂-CH₄-N₂ mixtures)")
		self.master.geometry("750x650")
		self.master.resizable(width=False, height=False)
		self.master.iconbitmap(resource_path("logo.ico"))
		self.frame=tk.Frame(self.master)
		...
		self.Rbtn1=tk.Radiobutton(self.frame, text="Others", variable=instrument, value=2, padx = 20,  command=selected_instrument).grid(row=26, column=2,  padx=10, sticky="W")
...
class module7: 
	def __init__(self, master, number):
		...
		self.master.title("FRAnCIs v.1.0 - (CH₄ dissolved and non-dissolved in H₂O)")
		self.master.resizable(width=False, height=False)
		self.master.iconbitmap(resource_path("logo.ico"))
		self.frame=tk.Frame(self.master)
		self.frame.grid()
